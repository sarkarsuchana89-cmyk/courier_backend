  ...
  db.getConnection((err, conn) => {
    ...
    conn.beginTransaction((err) => {
      ...
      conn.query(shipmentSql, [
        ...
        const values = [
          [shipmentId, "sender", sender.name, sender.address, sender.pincode_id, sender.city_id, sender.district_id, sender.state_id, sender.country_id, sender.phone, sender.whatsapp, sender.email],
          [shipmentId, "receiver", receiver.name, receiver.address, receiver.pincode_id, receiver.city_id, receiver.district_id, receiver.state_id, receiver.country_id, receiver.phone, receiver.whatsapp, receiver.email]
        ];
